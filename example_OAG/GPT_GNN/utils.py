...
def edge_emb_dict_to_device(edge_emb_dict, device):
    for target_type in edge_emb_dict:
        for source_type in edge_emb_dict[target_type]:
            for relation_type in edge_emb_dict[target_type][source_type]:
                edge_emb_dict[target_type][source_type][relation_type].to(device)
                print(edge_emb_dict[target_type][source_type][relation_type].device)
